$(function() {
  ...
  $('.prompt').html('[user@nomeDoUsuario] # ');
...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
  ...
  return {
    init: function() {
      output('<h2 style="letter-spacing: 4px">WebShell - FGR Software Distribution</h2><p>' + new Date() + '</p><p>Digite "help" para mais informações.</p>');
    },
    output: output
  }
};
